...
function SearchGameScreen(props) {
  ...
  // =========================================
  // 3. State giữ chữ user đang nhập
  // =========================================
  ...
  // =========================================
  // 5. Kiểm tra một game có match không
  // =========================================

  function gameMatchesSearch(game) {

    // Nếu chưa nhập gì
    // thì cho hiện tất cả game
    if (searchText.trim() === '') {
      return true;
    }
  ...
  const filteredGames =
    items.filter(gameMatchesSearch);
